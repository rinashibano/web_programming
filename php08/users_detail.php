  ...
  <div class="jumbotron">
   <fieldset>
    <legend>A学校：先生/学生登録</legend>
     ...
     <label>管理FLG：
      一般（学生）<input type="radio" name="kanri_flg" value="0" value="<?=$res["kanri_flg"]?>">　
      管理者（先生）<input type="radio" name="kanri_flg" value="1" value="<?=$res["kanri_flg"]?>">
    </label>
    <br>
     <label>在学FLG：
      在学<input type="radio" name="life_flg" value="0" value="<?=$res["life_flg"]?>">　
      卒業<input type="radio" name="life_flg" value="1" value="<?=$res["life_flg"]?>">
    </label>
    <br>
